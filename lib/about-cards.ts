...
type ReactNodeLike = {
  text: string;
  variant?: "p" | "lead" | "italic" | "italicAccent";
};
...
export const ABOUT_CARDS: AboutCard[] = [
  {
    ...
    body: [
      ...
      { text: "Work out what is really happening. Find the bit that matters. Build around that. That is WHATBIT.", variant: "lead" },
  ...
  },
  {
    ...
    eyebrow: "OUR VALUES",
    body: [
      { text: "01 — Start with the real problem", variant: "lead" },
      { text: "We do not begin with a product and look for somewhere to put it. We investigate first. What is happening? Where is the friction? What assumptions are hiding inside the current approach? Sometimes the most valuable thing we can do is challenge the original brief." },
      { text: "02 — Useful beats impressive", variant: "lead" },
      { text: "If it does not make work clearer, faster, safer, easier or more effective in the real world, the cleverness is mostly decoration. We like ambitious ideas and new technology. We also think there is an enormous difference between something that demos well and something that remains useful three weeks later." },
      { text: "03 — Use the shortest path that works", variant: "lead" },
      ...
      { text: "04 — Show the working", variant: "lead" },
      { text: "We do not like black boxes. When technology influences a decision, calculation or recommendation, people should be able to understand what went into it — particularly when AI is involved. We want systems that expose assumptions, uncertainty and reasoning boundaries rather than asking people to trust an answer because the computer produced it." },
      { text: "05 — Keep humans in the important bits", variant: "lead" },
      { text: "AI can research, organise, calculate, compare, test, generate and monitor at extraordinary speed. That does not make it responsible for the decision. Where context, judgement, ethics, taste, expertise or accountability matter, a person should remain meaningfully involved." },
      { text: "06 — Build across boundaries", variant: "lead" },
      { text: "Real problems rarely respect departments. A workflow problem can also be a design problem. A technology problem may actually be an incentive problem. We are comfortable moving between disciplines when the problem requires it — we would rather follow the problem than defend a category." },
      { text: "07 — Say when something does not make sense", variant: "lead" },
      { text: "Not every idea is good because it is ours. Not every client request should be built exactly as requested. We would rather identify a weak assumption early than spend months making it expensive. Good problem solving occasionally requires being willing to say: we don’t think that’s the problem.", variant: "italicAccent" },
    ],
  },
  {
    kind: "quote",
    lines: ["USEFUL", "BEATS", "IMPRESSIVE"],
    image: "/about/quote-2.jpg",
  ...
  },
  {
    ...
    body: [
      ...
      { text: "Or somebody says: “Surely there is a better way to do this.”", variant: "italicAccent" },
  ...
  },
  {
    ...
    body: [
      ...
      { text: "Use machines for what machines are increasingly excellent at, and keep people responsible for what still requires people.", variant: "lead" },
  ...
  },
  {
    ...
    body: [
      { text: "WHATBIT has two people. That is not quite the whole story.", variant: "lead" },
      ...
      { text: "Why “Elsewhere”?", variant: "lead" },
      ...
      { text: "What it is not", variant: "lead" },
      ...
      { text: "Small team. Larger field of capability.", variant: "lead" },
  ...
  },
  {
    ...
    body: [
      ...
      { text: "Pol’s work centres on investigation, behavioural science, research, product thinking and finding patterns across complicated systems." },
      { text: "Josh brings a practical implementation and operational lens: how something works, what it takes to deliver it, and whether the idea survives contact with the real world." },
