...
/**
 * AssessmentRepository implementation — CURRENT D1/KV adapter.
 * Maps 1:1 onto the functions above; behaviour identical. Phase B will add
 * an Nhost/Postgres adapter behind the same interface (see repository.ts).
 */
