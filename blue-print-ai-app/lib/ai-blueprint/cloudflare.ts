// Transitional fallback IDs below are the current whatbit-web D1/KV bindings.
// They remain only so Phase A keeps working before environment configuration
// is externalised; set AI_BLUEPRINT_D1_DATABASE_ID / AI_BLUEPRINT_KV_NAMESPACE_ID
// in the blue-print-ai-app environment and remove the fallbacks once verified.
const D1_DATABASE_ID = process.env.AI_BLUEPRINT_D1_DATABASE_ID || "23e7166e-5001-4e39-bba8-ff53a811b9f6";
const KV_NAMESPACE_ID = process.env.AI_BLUEPRINT_KV_NAMESPACE_ID || "d7b498e7fd1e43a0ad8ecf21f2d11467";
