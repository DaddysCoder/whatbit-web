    ...
    <DocPage
      ...
      blocks={[
        ...
        },
        {
          ...
          text: "Messages submitted through the WhatBit contact form (your name, email address, contact reason and message) are sent to our business inbox at hello@primitiveai.com.au using Resend, a third-party transactional email service that processes the message on our behalf. Your contact reason appears in the email subject line, and your email address is set as the reply-to address so we can respond to you directly. Please do not include passwords, API keys, payment-card numbers, health information or other highly sensitive information in an ordinary website enquiry unless it is genuinely necessary and you are authorised to provide it.",
        },
        {
